...
class ManagerAccessTokens(models.Model):
...
class ManagerPasswordResetTokens(models.Model):
    manager = models.ForeignKey(Manager, on_delete=models.SET_NULL, null=True)
    resetToken = models.TextField("reset_token")
...
class ControllerAccessTokens(models.Model):
...
class ControllerPasswordResetTokens(models.Model):
    controller = models.ForeignKey(Controller, on_delete=models.SET_NULL, null=True)
    resetToken = models.TextField("reset_token")
